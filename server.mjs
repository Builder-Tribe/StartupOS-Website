...
const INITIAL_COBUILDERS = [
  ...
  },
  {
    ...
    seekingDescription: "Seeking a product-minded engineer or PM to scale our AI-native tactical persuasion arena into an interactive multiplayer SaaS.",
    commitment: "part_time",
    commitmentLabel: "Nights & Weekends (15h/wk)",
    stage: "parity_verified",
    stageLabel: "Parity-Verified Open Source",
    projects: [
      { name: "TicTacCourt", role: "AI Game Designer & Engineer", url: "https://github.com/1997agarwal/TicTacCourt" }
    ],
...
const INITIAL_PROJECTS = [
  ...
  },
  {
    ...
    demoUrl: "https://github.com/1997agarwal/TicTacCourt",
